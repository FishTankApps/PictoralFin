...
public class Theme implements Serializable{
	...
	public static final Theme OCEAN_THEME =     new Theme(new Color(25,25,25),    new Color(255,255,250), 
			new Color(93,137,170), new Color(0,187,179), "Papyrus",          "Blackadder ITC", false);
	
	public static final Theme RED_METAL_THEME = new Theme(new Color(169,169,169), new Color(192,192,192),
			new Color(240,26,26),  new Color(135,23,23), "BankGothic Lt BT", "Magneto",        true);
